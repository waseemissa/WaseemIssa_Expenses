...
if(!empty($row1)){
    ...
    $query2 = "INSERT INTO users(first_name, last_name, date_of_birth, email, password) VALUES (?,?,?,?,?)";
    $stmt2 = $connection->prepare($query2);
    $stmt2->bind_param("sssss", $first_name, $last_name, $final_date, $email, $hashed_password);
    $stmt2->execute();
